...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content-project">
	 ...
	 <ul class="icon">
        ...
        <div class="pluso" data-options="medium,square,line,horizontal,counter,theme=03" data-services="vkontakte,facebook,email,print" data-background="transparent" data-user="1130257394"></div>
		</li>
	 </ul>
	...
	<?php if(!empty($images)) :	?>
        ...
        </div>		<div class="location"> 		 <a  class="googlemap-link" href="#mapshow"> 		<div style="width:200px; height: 75px"> <img width="100" height="65" src="http://www.genesisvilla.com/wp-content/uploads/2013/02/map_small.png" class="attachment-full" alt="Genesis Villa in map" title="Go to map"/>		<div style ="position:relative; left:110px; top:-50px;"> <?php echo $custom_post['Location'][0];?> </div></a>				</div>		</div> 						
		<?php 
